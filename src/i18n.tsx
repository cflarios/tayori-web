...
export const dict = {
  en: {
    ...
    vanish: {
      ...
      title: 'You see the overlay. They don’t.',
      sub: 'Same call, two views. Your assistant floats on your screen — and even while you share that screen, it’s simply never in what everyone else gets.',
      yours: 'Your screen',
      yoursSub: 'overlay on top',
      theirs: 'What everyone else sees',
      theirsSub: 'nothing extra',
      sharing: 'You are sharing your screen',
      you: 'You',
      other: 'Alex',
      benefits: ['Invisible on screen shares', 'No bot joins the call', 'Never steals focus from your meeting'],
      overlayHint: 'Suggested answer',
      note: 'No blur, no cropping, no “drag the window off-screen.” Windows simply never draws the overlay into the shared frame.',
    },
    features: {
      kicker: 'What it does',
      ...
      items: [
        ...
        { icon: 'code', t: 'Solve what’s on your screen', d: 'One Solve screen button reads your screen with a vision model: solve code (Ctrl+Alt+C), answer a quiz (Ctrl+Alt+Q), or get help with anything else — an error, some logs, a diagram.' },
  ...
  es: {
    ...
    vanish: {
      ...
      title: 'Tú ves el overlay. Ellos no.',
      sub: 'La misma llamada, dos vistas. Tu asistente flota en tu pantalla — y aunque compartas esa pantalla, sencillamente nunca está en lo que recibe el resto.',
      yours: 'Tu pantalla',
      yoursSub: 'con el overlay encima',
      theirs: 'Lo que ve el resto',
      theirsSub: 'nada de más',
      sharing: 'Estás compartiendo tu pantalla',
      you: 'Tú',
      other: 'Alex',
      benefits: ['Invisible al compartir pantalla', 'Ningún bot entra en la llamada', 'Nunca roba el foco de tu reunión'],
      overlayHint: 'Respuesta sugerida',
      note: 'Sin desenfoque, sin recorte, sin “mueve la ventana fuera de pantalla”. Windows simplemente nunca dibuja el overlay en el frame compartido.',
    },
    features: {
      kicker: 'Qué hace',
      ...
      items: [
        ...
        { icon: 'code', t: 'Resuelve lo que haya en pantalla', d: 'Un botón «Resolver la pantalla» la lee con un modelo con visión: resuelve código (Ctrl+Alt+C), responde un test (Ctrl+Alt+Q) o ayuda con cualquier otra cosa — un error, unos logs, un diagrama.' },
